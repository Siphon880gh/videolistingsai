            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="md:col-span-2 text-center md:text-left">
                  ...
                  />
                  <p className="text-sm text-gray-600 mb-4">From static to cinematic<br/>Convert your property photos into video so that buyers "get it"</p>
                  <p className="text-sm text-gray-600">
                    <a href="mailto:support@videolistings.ai" className="hover:text-primary transition-colors">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="space-y-2 flex flex-col items-center md:items-start">
                    <a href="https://www.instagram.com/videolistingsai/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-600 hover:text-primary transition-colors">
                    ...
                    <a href="https://www.facebook.com/videolistingsai/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-600 hover:text-primary transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                      </svg>
                      Facebook
                    </a>
                    <a href="https://www.linkedin.com/company/videolistingsai/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-600 hover:text-primary transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <p className="text-sm text-gray-500 text-center">
                  © 2024 VideoListings.ai. All rights reserved.
                </p>
              </div>
            </div>
          </footer>
