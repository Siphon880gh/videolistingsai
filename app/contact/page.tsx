            ...
            <div className="space-y-8">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* Sales Inquiries */}
                  <div className="flex items-start space-x-3">
                    <div className="bg-brand-primary/80 text-white w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  {/* Partnerships */}
                  <div className="flex items-start space-x-3">
                    <div className="bg-brand-secondary border-2 border-brand-primary text-brand-primary w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
